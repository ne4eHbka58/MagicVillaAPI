...
const CreateVilla_1 = __importDefault(require("../../components/CreateVilla/CreateVilla"));
...
const CreateVillaPage = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Header_1.default, { name: userName, surname: userSurname }), (0, jsx_runtime_1.jsx)(CreateVilla_1.default, {})] }));
};
exports.default = CreateVillaPage;
